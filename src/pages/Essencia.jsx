// src/pages/Essencia.jsx
// Página de Essência da História do StoryForge
  ...
  return (
    <main className="module-page w-full">
      ...
      <header className="module-header flex justify-between items-center">
        <div>
          <h1>Essência da História</h1>
          <p>A alma e o coração da narrativa — defina o que torna sua obra única, universal e emocionante.</p>
        </div>
